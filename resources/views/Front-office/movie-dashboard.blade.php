...
<head>
    ...
    <title>Responsive movie dashboard - Bedimcode</title>
</head>
<body>
    <img src="{{ asset('assets/img/banner.png') }}" alt="image" class="bg__image">
    ...
    <nav class="nav" id="nav">
        <div class="nav__menu">
            ...
            <ul class="nav__list">
                ...
                <li class="nav__item">
                    <a href="#" class="nav__link">
                        <i class="ri-movie-line"></i> <span>Movies</span>
                    </a>
                </li>

                <li class="nav__item">
                    <a href="./tv-shows" class="nav__link">
                        <i class="ri-film-line"></i> <span>Series</span>
                    </a>
                </li>
        ...
        <section class="banner">
            <article class="banner__card">
                <a href="#" class="banner__link">
                    <img src="{{ asset('assets/img/banner.png') }}" alt="image" class="banner__img">
                ...
                <div class="swiper-wrapper">
                    <article class="card__article swiper-slide">
                        <a href="#" class="card__link">
                            <img src="{{ asset('assets/img/movie-1.png') }}" alt="image" class="card__img">
                    ...
                    <article class="card__article swiper-slide">
                        <a href="#" class="card__link">
                            <img src="{{ asset('assets/img/movie-2.png') }}" alt="image" class="card__img">
                            <div class="card__shadow"></div>
                    ...
                    <article class="card__article swiper-slide">
                        <a href="#" class="card__link">
                            <img src="{{ asset('assets/img/movie-3.png') }}" alt="image" class="card__img">
                            <div class="card__shadow"></div>
                    ...
                    <article class="card__article swiper-slide">
                        <a href="#" class="card__link">
                            <img src="{{ asset('assets/img/movie-4.png') }}" alt="image" class="card__img">
                            <div class="card__shadow"></div>
                    ...
                    <article class="card__article swiper-slide">
                        <a href="#" class="card__link">
                            <img src="{{ asset('assets/img/movie-5.png') }}" alt="image" class="card__img">
                            <div class="card__shadow"></div>
                    ...
                    <article class="card__article swiper-slide">
                        <a href="#" class="card__link">
                            <img src="{{ asset('assets/img/movie-6.png') }}" alt="image" class="card__img">
                            <div class="card__shadow"></div>
            ...
            <div class="new__swiper swiper">
                <div class="swiper-wrapper">
                    <article class="new__card card__article swiper-slide">
                        <a href="#" class="card__link">
                            <img src="{{ asset('assets/img/new-1.png') }}" alt="image" class="card__img">
                            <div class="card__shadow"></div>
                    ...
                    <article class="new__card card__article swiper-slide">
                        <a href="#" class="card__link">
                            <img src="{{ asset('assets/img/new-2.png') }}" alt="image" class="card__img">
                            <div class="card__shadow"></div>
                    ...
                    <article class="new__card card__article swiper-slide">
                        <a href="#" class="card__link">
                            <img src="{{ asset('assets/img/new-3.png') }}" alt="image" class="card__img">
                            <div class="card__shadow"></div>
                    ...
                    <article class="new__card card__article swiper-slide">
                        <a href="#" class="card__link">
                            <img src="{{ asset('assets/img/new-4.png') }}" alt="image" class="card__img">
                            <div class="card__shadow"></div>
                    ...
                    <article class="new__card card__article swiper-slide">
                        <a href="#" class="card__link">
                            <img src="{{ asset('assets/img/new-5.png') }}" alt="image" class="card__img">
                            <div class="card__shadow"></div>
                    ...
                    <article class="new__card card__article swiper-slide">
                        <a href="#" class="card__link">
                            <img src="{{ asset('assets/img/new-6.png') }}" alt="image" class="card__img">
                            <div class="card__shadow"></div>
