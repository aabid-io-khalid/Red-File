            ...
            <div class="flex flex-col h-full justify-between p-4">
                ...
                <nav class="flex-grow">
                    <ul class="space-y-1">
                        ...
                        <li>
                            <a href="admin/movies" class="flex items-center p-3 text-gray-100 rounded-lg hover:bg-gray-700/50 group transition-all">
                        ...
                        <li>
                            <a href="admin/users" class="flex items-center p-3 text-gray-100 rounded-lg hover:bg-gray-700/50 group transition-all">
