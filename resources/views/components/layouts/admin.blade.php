...
<head>
    ...
    <title>@yield('title', 'PELIXS Admin Dashboard')</title>
...
<body class="bg-dark-900 text-white font-sans" @yield('body-attributes')>
    ...
    <div class="flex min-h-screen">
        ...
        <aside id="sidebar" class="fixed top-0 left-0 h-full w-64 bg-dark-800/80 backdrop-blur-md z-40 transform transition-transform duration-300 ease-in-out lg:translate-x-0 -translate-x-full shadow-xl border-r border-dark-700/50">
            <div class="flex flex-col h-full justify-between p-4">
                ...
                <nav class="flex-grow">
                    <ul class="space-y-2">
                        <li>
                            <a href="{{ route('admin.index') }}" class="sidebar-item flex items-center p-3 text-gray-100 rounded-lg hover:bg-dark-700/50 group transition-all">
                        ...
                        {{-- <li>
                            <a href="/admin/analytics" class="sidebar-item flex items-center p-3 text-gray-100 rounded-lg hover:bg-dark-700/50 group transition-all">
                                <i class="ri-bar-chart-line text-lg mr-3 text-primary group-hover:text-white transition-colors duration-300"></i>
                                <span>Analytics</span>
                            </a>
                        </li> --}}
                    </ul>
        ...
        <main class="flex-1 transition-all duration-300 lg:ml-64">
            ...
            <header class="bg-dark-800/70 backdrop-blur-md border-b border-dark-700/50 py-4 px-6 sticky top-0 z-30">
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm text-gray-400">
                        <span id="current-date-time">{{ date('F j, Y') }}</span>
                    </div>
                    @show
                </div>
            </header>
            ...
            <footer class="bg-dark-800/50 backdrop-blur-sm border-t border-dark-700/30 p-4 text-center text-gray-400 text-sm">
                <p>&copy; @php echo date('Y'); @endphp Ycode Admin Dashboard. All rights reserved.</p>
            </footer>
        </main>
    </div>
