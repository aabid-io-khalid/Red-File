...
<head>
    ...
    <title>PELIXS - <?php echo e($movieData['title'] ?? 'Movie Details'); ?></title>
    <script>
        tailwind.config = {
            theme: {
                extend: {
...
<body class="bg-darker text-white font-sans">
    ...
    <main class="pt-16" id="main-content">
        ...
        <div class="relative h-[70vh] w-full" id="movie-banner">
            <img src="<?php echo e($movieData['backdrop_path'] ? 'https://image.tmdb.org/t/p/original' . $movieData['backdrop_path'] : '/api/placeholder/1920/800'); ?>" 
                 alt="<?php echo e($movieData['title']); ?>" 
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="flex flex-wrap items-center gap-4 mb-6">
                        <div id="movie-rating" class="rating-pill text-sm px-3 py-1.5 rounded-full flex items-center">
                            ...
                            <span><?php echo e($movieData['vote_average'] ? number_format($movieData['vote_average'], 1) : 'N/A'); ?></span>
                        </div>
                        <div id="movie-year" class="genre-pill text-sm px-3 py-1.5 rounded-full">
                            <?php echo e($movieData['release_date'] ? date('Y', strtotime($movieData['release_date'])) : 'N/A'); ?>

                        </div>
                        <div id="movie-runtime" class="genre-pill text-sm px-3 py-1.5 rounded-full flex items-center">
                            <i class="ri-time-line mr-1"></i>
                            <span><?php echo e($movieData['runtime'] ? $movieData['runtime'] . ' min' : 'N/A'); ?></span>
                        </div>
                    ...
                    <!-- Movie Description -->
                    <div class="mb-8">
                        <h2 class="text-3xl font-bold mb-4" id="movie-title"><?php echo e($movieData['title']); ?></h2>
                        <p class="text-gray-300 mb-4" id="movie-overview"><?php echo e($movieData['overview'] ?: 'No overview available.'); ?></p>
                        
                        <!-- Genres -->
                        <div class="flex flex-wrap gap-2 mb-6" id="movie-genres">
                            <?php $__empty_1 = true; $__currentLoopData = $movieData['genres']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $genre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <span class="text-sm bg-gray-800 px-3 py-1.5 rounded-full"><?php echo e($genre['name']); ?></span>
                        ...
                        <div class="flex flex-wrap gap-4">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add-to-my-list')): ?>
                                <button 
                                    id="movie-<?php echo e($movieData['id']); ?>-button"
                                    onclick="toggleMyList(<?php echo e($movieData['id']); ?>)"
                    ...
                    <div id="download-section" class="mt-4">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('download-content')): ?>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="swiper-container cast-swiper">
                            <div class="swiper-wrapper" id="cast-wrapper">
                                <?php $__empty_1 = true; $__currentLoopData = $movieData['credits']['cast'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $person): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="swiper-slide">
                                        <div class="text-center">
                                            <div class="w-24 h-24 mx-auto rounded-full overflow-hidden mb-3 border-2 border-gray-700">
                                                <img src="<?php echo e($person['profile_path'] ? 'https://image.tmdb.org/t/p/w185' . $person['profile_path'] : '/api/placeholder/185/278'); ?>" 
                                                     alt="<?php echo e($person['name']); ?>" 
                                                     class="w-full h-full object-cover">
                                            </div>
                                            <h4 class="font-medium text-sm"><?php echo e($person['name']); ?></h4>
                                            <p class="text-xs text-gray-400"><?php echo e($person['character']); ?></p>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            ...
                            <div class="space-y-3">
                                <div class="flex flex-wrap">
                                    ...
                                    <span id="movie-director">
                                        <?php echo e($movieData['credits']['crew'] ? collect($movieData['credits']['crew'])->firstWhere('job', 'Director')['name'] ?? 'N/A' : 'N/A'); ?>
                                ...
                                <div class="flex flex-wrap">
                                    ...
                                    <span id="movie-writer">
                                        <?php echo e($movieData['credits']['crew'] ? collect($movieData['credits']['crew'])->filter(fn($person) => in_array($person['job'], ['Writer', 'Screenplay']))->pluck('name')->take(2)->implode(', ') ?: 'N/A' : 'N/A'); ?>
                                ...
                                <div class="flex flex-wrap">
                                    ...
                                    <span id="movie-production">
                                        <?php echo e($movieData['production_companies'] ? collect($movieData['production_companies'])->take(2)->pluck('name')->implode(', ') ?: 'N/A' : 'N/A'); ?>
                                ...
                                <div class="flex flex-wrap">
                                    ...
                                    <span id="movie-country">
                                        <?php echo e($movieData['production_countries'] ? collect($movieData['production_countries'])->pluck('name')->implode(', ') ?: 'N/A' : 'N/A'); ?>
                            ...
                            <div class="space-y-3">
                                <div class="flex flex-wrap">
                                    ...
                                    <span id="movie-release-date">
                                        <?php echo e($movieData['release_date'] ? date('F j, Y', strtotime($movieData['release_date'])) : 'N/A'); ?>
                                ...
                                <div class="flex flex-wrap">
                                    ...
                                    <span id="movie-budget">
                                        <?php echo e($movieData['budget'] ? '$' . number_format($movieData['budget'] / 1000000, 1) . ' million' : 'N/A'); ?>
                                ...
                                <div class="flex flex-wrap">
                                    ...
                                    <span id="movie-revenue">
                                        <?php echo e($movieData['revenue'] ? '$' . number_format($movieData['revenue'] / 1000000, 1) . ' million' : 'N/A'); ?>

                                    </span>
                                </div>
                                <div class="flex flex-wrap">
                                    <span class="text-gray-400 w-32">Status:</span>
                                    <span id="movie-status"><?php echo e($movieData['status'] ?? 'N/A'); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="swiper-container similar-swiper">
                            <div class="swiper-wrapper" id="similar-wrapper">
                                <?php $__empty_1 = true; $__currentLoopData = $movieData['similar']['results'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="swiper-slide">
                                        <div class="movie-card relative overflow-hidden rounded-lg">
                                            <img src="<?php echo e($item['poster_path'] ? 'https://image.tmdb.org/t/p/w342' . $item['poster_path'] : '/api/placeholder/342/513'); ?>" 
                                            ...
                                            <div class="absolute inset-0 card-overlay flex items-center justify-center opacity-0 transition-opacity duration-300">
                                                <a href="/movie/<?php echo e($item['id']); ?>" class="bg-primary text-white px-4 py-2 rounded-lg flex items-center">
                                                    <i class="ri-play-fill mr-2"></i> Watch
                                                </a>
                                            </div>
                                        </div>
                                        <h4 class="mt-2 text-sm font-medium"><?php echo e($item['title']); ?></h4>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="relative aspect-video bg-dark rounded-xl overflow-hidden" id="trailer-container">
                            ...
                            ?>
                            <?php if($trailer && $trailer['site'] === 'YouTube'): ?>
                                <iframe 
                                    width="100%" 
                                    height="100%" 
                                    src="https://www.youtube.com/embed/<?php echo e($trailer['key']); ?>" 
                                    title="<?php echo e($trailer['name']); ?>" 
                                    frameborder="0" 
                    ...
                    <div class="mb-8">
                        ...
                        <div class="flex flex-wrap gap-2" id="keywords-container">
                            <?php $__empty_1 = true; $__currentLoopData = $movieData['keywords']['keywords'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyword): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <span class="text-sm bg-gray-800 px-3 py-1.5 rounded-full"><?php echo e($keyword['name']); ?></span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <script>
        const mediaData = <?php echo json_encode($movieData, 15, 512) ?>;
        const isInList = <?php echo json_encode($isInList, 15, 512) ?>;
        ...
        document.getElementById('fetch-download-btn')?.addEventListener('click', function() {
            const movieTitle = "<?php echo e($movieData['title']); ?>";
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function getUserId() {
                return <?php echo json_encode(auth()->user()->id ?? null, 15, 512) ?>;
            }
...
</html><?php /**PATH C:\Users\Youcode\Herd\file-rouge\resources\views/Front-office/details.blade.php ENDPATH**/ ?>