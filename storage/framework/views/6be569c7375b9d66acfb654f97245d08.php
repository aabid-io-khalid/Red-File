        ...
        <div class="container mx-auto">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
                <h1 class="text-3xl font-bold mb-4 md:mb-0">
                    ...
                    <?php elseif($sort == 'trending'): ?> Trending TV Shows
                    <?php elseif($sort == 'release_date' && $order == 'desc'): ?> New TV Shows
                    <?php elseif($sort == 'vote_average' && $order == 'desc'): ?> Top Rated TV Shows
                    <?php else: ?> TV Shows <?php endif; ?>
                </h1>
            </div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 md:gap-6">
                <?php $__empty_1 = true; $__currentLoopData = $content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    ?>
                    <?php if($id): ?>
                        <a href="<?php echo e($isLocal ? route('tv-shows.local', $id) : route('tv-shows.details', $id)); ?>"
...
</html><?php /**PATH C:\Users\Youcode\Herd\file-rouge\resources\views/Front-office/shows.blade.php ENDPATH**/ ?>